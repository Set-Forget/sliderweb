...
export default function InfoPage({ params }) {
  ...
  if (route.info_route === "privacypolicy") {
    content = (
      <>
        ...
        <p className="leading-8 text-gray-300 mt-6 text-sm">{data.privacypolicy.content}</p>
      </>
    );
    ...
    content = (
      <>
        ...
        <p className="leading-8 text-gray-300 mt-6 text-sm">{data.termsandconditions.content}</p>
      </>
    );
    ...
    content = (
      <>
        ...
        <p className="leading-8 text-gray-300 mt-6 text-sm">
  ...
  return (
    <div className="mx-auto custom-min-height px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-40 bg-gray-900 flex flex-col items-center justify-center">
