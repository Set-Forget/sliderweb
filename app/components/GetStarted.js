    ...
    return (
        <div className="relative isolate dark:bg-gray-900 flex flex-col justify-center items-center">
            <div className="mx-auto px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-40 flex flex-col justify-center items-center max-w-[1366px]">
                <h2 className="text-4xl font-bold tracking-tight sm:text-6xl mt-6 text-center">
                Install <span className="dark:text-[#fbbc05] text-white">SliderWeb&apos;s</span> Google Slides Addon and Improve Your Workflow in a Heartbeat.
                </h2>
